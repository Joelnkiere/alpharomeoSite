          ...
          <div class="card card-outline card-info">
			...
			<div class="card-header">
             <div class="form-group">
                 ...
                 <input type="text" name="cat_name" value="<?php echo $roww["cat_name"]; ?>" class="form-control" placeholder="Entrer la categorie ...">
                </div>
            </div>
				  ...
				  <tr>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="add-category.php?delete_id=<?php echo $location_ft["id"]; ?>" onclick="return confirm('êtes-vous sûre de vouloir supprimer?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                </tr>
		<?php
