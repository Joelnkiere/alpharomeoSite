  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>jouter une offre</h1>
          </div>
           <div class="col-sm-6">
          <a href="view-testimonials.php" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i>  Voir les offres</a>
          </div>
      ...
      <div class="row">
		...
		<form action="" method="post" enctype="multipart/form-data">
          <div class="card card-outline card-info">
            ...
            <div class="card-header">
             <div class="form-group">
                  <label>Entrer la Designation</label>
