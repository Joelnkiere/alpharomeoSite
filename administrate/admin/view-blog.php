      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
			...
			?> 
				  <tr>
					<td><img style="width:100px;" src="images/blog/<?php echo $roww["img"]; ?>"></td>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="view-blog.php?delete_id=<?php echo $roww["id"]; ?>" onclick="return confirm('êtes-vous sûre de vouloir supprimer?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                </tr>
			<?php 
