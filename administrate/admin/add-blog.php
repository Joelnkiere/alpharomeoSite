...
if($edit==''){
$insertdata = mysqli_query($con,"INSERT INTO blog(title,category,descrip,img,date,status,auteur)VALUES('$title','$category','$descrip','$lis_img','$today','0','$auteur')");
echo "<script>alert('la publicationa été effectuée!!');</script>
	<script>window.location.href = 'view-blog.php'</script>";
}
else{
$insertdata = mysqli_query($con,"UPDATE blog SET title='$title',category='$category',descrip='$descrip',img='$lis_img',date='$today',auteur='$auteur' where id=".$edit."");
          ...
          <div class="card card-outline card-info">
			...
			<div class="card-header">
             <div class="form-group">
                 ...
                 <input name="title" value="<?php echo $roww["title"]; ?>" type="text" class="form-control" placeholder="Entrer le titre de la publication">
                </div>
            </div>
            	<div class="card-header">
             <div class="form-group">
