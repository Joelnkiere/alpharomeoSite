...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block mb-3">Nouveau message</a>
...
// Fermer la connexion
      ...
      ?>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="detail-message?id=<?php echo $roww['id_mes']; ?>"><?php echo $roww['nom_cli']; ?></a></td>
                    <td class="mailbox-subject"><b><a href="detail-message?id=<?php echo $roww['id_mes']; ?>" style="color:black;"><?php echo $roww['titre']; ?> </a> 
                        </b>
                        <td>
                          <b>
                            <a href="detail-message?id=<?php echo$roww['id_mes'];?>" style="color: black;">
                              - 
                      <?php 
                            $ddesc = $roww['message']; 
                    ...
                    <td class="mailbox-date"> <a href="detail-message?id=<?php echo$roww['id_mes']; ?>" style="color: black;"><?php echo $roww['date_envoi'];?></a></td>
                    <td>
                      <div class="btn-group">
                      
                      <a href="message.php?delete_id=<?php echo$roww['id_mes']; ?>" class="btn btn-default btn-sm">
                    <i class="far fa-trash-alt"></i>
                  </a>
