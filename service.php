...
<body>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-4">
                        ...
                        <h2 class="text-white mb-0">+243 974720328</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Tarification des Services</h5>
                <h1 class="mb-0">Nous vous offrons des services à des prix abordables</h1>
            </div>
            <div class="row g-0">
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.6s">
                    <div class="bg-light rounded">
                        <div class="border-bottom py-4 px-4 mb-4">
                            <h4 class="text-primary mb-1">Graphisme</h4>
                            <small class="text-uppercase">Les tâches concernées</small>
                        </div>
                        <div class="p-4 pt-0">
                            
                            <div class="d-flex justify-content-between mb-3"><span>Creation de logos</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Creation d'affiches</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Creation de flyers</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Creation des maquettes</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Bannieres publicitaires</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Couvertures des livres</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <a href="quote.php" class="btn btn-primary py-2 px-4 mt-4">commander</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                        <div class="border-bottom py-4 px-4 mb-4">
                            <h4 class="text-primary mb-1">Marketing Digital</h4>
                            <small class="text-uppercase">Les tâches concernées</small>
                        </div>
                        <div class="p-4 pt-0">
                            
                            <div class="d-flex justify-content-between mb-3"><span>Strategie Digitale</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Gestion des Contenus</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Gestion des reseaux sociaux</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Publicité en ligne</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Referencement</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Le trading</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <a href="quote.php" class="btn btn-primary py-2 px-4 mt-4">commander</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.9s">
                    <div class="bg-light rounded">
                        <div class="border-bottom py-4 px-4 mb-4">
                            <h4 class="text-primary mb-1">Site web et App</h4>
                            <small class="text-uppercase">Les tâches concernées</small>
                        </div>
                        <div class="p-4 pt-0">
                            
                            <div class="d-flex justify-content-between mb-3"><span>Site E-commerce</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Site d'entreprise</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Site personnel</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Site vitrine</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Application mobile</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>logiciel de gestion</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <a href="quote.php" class="btn btn-primary py-2 px-4 mt-4">commander</a>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                        <div class="border-bottom py-4 px-4 mb-4">
                            <h4 class="text-primary mb-1">Formations Pro</h4>
                            <small class="text-uppercase">Les tâches concernées</small>
                        </div>
                        <div class="p-4 pt-0">
                            
                            <div class="d-flex justify-content-between mb-3"><span>Developpement web</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Developpement desktop</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span>Developpement mobile</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Formation base des données</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Modelisation informatique</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span>Formation marketing Digital</span><i class="fa fa-check text-primary pt-1"></i></div>
                            <a href="quote.php" class="btn btn-primary py-2 px-4 mt-4">commander</a>
                        </div>
                    </div>
                </div>
